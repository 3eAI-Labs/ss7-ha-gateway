...
/**
 * Base class for all SS7 messages sent through Kafka
 */
@JsonTypeInfo(
...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(value = MoSmsMessage.class, name = "MO_FORWARD_SM"),
    @JsonSubTypes.Type(value = MapSriMessage.class, name = "MAP_SRI"),
    @JsonSubTypes.Type(value = CapInitialDPMessage.class, name = "CAP_INITIAL_DP"),
    @JsonSubTypes.Type(value = CapContinueMessage.class, name = "CAP_CONTINUE"),
    @JsonSubTypes.Type(value = CapReleaseMessage.class, name = "CAP_RELEASE")
})
