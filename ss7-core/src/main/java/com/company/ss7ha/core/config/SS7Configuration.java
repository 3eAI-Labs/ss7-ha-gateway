...
public class SS7Configuration {
    ...
    private int sccpLocalSsn = 8;  // SMSC SSN
    private int sccpRemoteSsn = 6; // HLR SSN
    private int sccpCapSsn = 146;  // CAP SSN for IN services
    
    // Generic GTs for external visibility (Active/Standby)
    private String genericGT1 = "123456789";  // Primary Generic GT
    private String genericGT2 = "123456790";  // Standby Generic GT
    ...
    public void loadFromProperties(Properties props) {
        ...
        // Generic GTs
        genericGT1 = props.getProperty("sccp.gt.generic1", genericGT1);
        genericGT2 = props.getProperty("sccp.gt.generic2", genericGT2);
    ...
    public String getGenericGT1() { return genericGT1; }
    public String getGenericGT2() { return genericGT2; }
